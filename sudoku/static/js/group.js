(function($){
  $.fn.board_group = function(board, group_index){
    ...
    // this rule removes the choices from each cell that are already definite 
    // for other cells
    ...
    this.is_solved = function(){
      var group_values = [1, 2, 3, 4, 5, 6, 7, 8, 9];
      this.cells.forEach(function(cell){
        delete(group_values[cell.get_single_choice()-1]);
      });
      return group_values.element_count() == 0 ? true : false;
    }
